...
enum SettingsCatalog {
    static let entries: [SettingsSearchEntry] = [
        SettingsSearchEntry(id: "accessibility", category: .general, title: "Accessibility permission", description: "Allow WindowManager to discover, move, resize, and focus windows.", synonyms: ["privacy", "grant access", "TCC"]),
        ...
        SettingsSearchEntry(id: "directional-move", category: .shortcuts, title: "Directional layout reorder", description: "Move the focused layout window earlier or later in its Tiled or Accordion order.", synonyms: ["Control Option arrows", "KEY-07"]),
...
enum SettingsCopy {
    static let restoreWindowManagerDefaultsTitle = "Restore WindowManager Defaults"
}
