...
enum SettingsCatalog {
    static let entries: [SettingsSearchEntry] = [
        ...
        SettingsSearchEntry(id: "profile-switching-triggers", category: .profileSwitching, title: "Automatic profile switching", description: "Choose this Mac's default, exact display mappings, and docked or undocked profiles.", synonyms: ["dock", "topology", "automatic selection", "manual override", "manual pin", "PRF-02", "PRF-06"]),
