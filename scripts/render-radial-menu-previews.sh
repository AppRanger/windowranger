...
/usr/bin/xcodebuild \
    ...
    -only-testing:WindowManagerTests/RadialMenuVisualSnapshotTests \
...
WINDOWMANAGER_RADIAL_SNAPSHOT_DIR="$output_directory" \
    /usr/bin/xcrun xctest \
    -XCTest WindowManagerTests.RadialMenuVisualSnapshotTests/testOffscreenProductionRadialMenuStates \
    "$test_bundle"
